...
const Contact = () => {
    ...
    return (
        <section id="contact" className="relative overflow-hidden py-20 gradient-subtle">
            <SectionBg/>
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-4">
                                    <div
                                        className="w-12 h-12 rounded-lg gradient-accent flex items-center justify-center flex-shrink-0 z-10">
                        ...
                        <div className="glass-effect p-6 rounded-lg">
                            ...
                            <div className="space-y-2 text-sm text-muted-foreground">
                                <div className="flex justify-between">
                                    ...
                                    <span
                                        className="font-medium text-foreground">{companyInfo.businessHours.weekdays}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span>Saturday:</span>
                                    <span
                                        className="font-medium text-foreground">{companyInfo.businessHours.saturday}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span>Sunday:</span>
                                    <span
                                        className="font-medium text-foreground">{companyInfo.businessHours.sunday}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Contact Form */}
                    <div className="glass-effect px-6 pb-8 pt-5 rounded-lg">
                        <div className="animate-scale-in">
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <Button type="submit" variant="hero" size="lg" className="w-full z-50">
