                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {teamMembers.map((member, index) => (
                        <Reveal key={index} delayMs={index * 100}
                                className="bg-card rounded-lg overflow-hidden shadow-soft hover:shadow-medium transition-all duration-300 group">
                            <div className="relative overflow-hidden h-64">
                                ...
                                />
                                <div
                                    className="absolute inset-0 bg-gradient-to-t from-card via-card/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-4">
                    ...
                    {teamMembers.length % 3 != 0 &&
                        (<Reveal delayMs={(teamMembers.length - 1) * 100}
                                 className="bg-card rounded-lg overflow-hidden shadow-soft hover:shadow-medium transition-all duration-300 group"
                        >
                            <div className="p-5 flex flex-col justify-center items-center h-full gap-3">
                                <p className="text-primary text-xl">Join With Us</p>
